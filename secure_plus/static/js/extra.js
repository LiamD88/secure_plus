...
anime.timeline({loop: true})    // this was taken from https://tobiasahlin.com/moving-letters/#14 to animate the text
  .add({
    targets: '.ml14 .line',
    scaleX: [0,1],
    opacity: [0.5,1],
...
// parallax image resize
                                            // this was taken from https://inkplant.com/code/responsive-parallax-images
