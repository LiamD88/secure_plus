...
class OrderForm(forms.ModelForm):
    ...
    postcode = forms.CharField(label='', widget=forms.TextInput(attrs={'required': 'False', 'class': 'form-control', 'placeholder': 'Postcode'}))
...
class PaymentForm(forms.Form):
    ...
    year_choice = [(i, i) for i in range(2020, 2030)]
    ...
    cvv= forms.CharField(label='', widget=forms.NumberInput(attrs={'required': 'True', 'class': 'form-control', 'placeholder': 'CVV'}))
